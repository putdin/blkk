                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="footer-logo">
                            <a href="" class="text-light" style="font-weight: bold; font-size: 20px;">BLKK-YPPRM</a>
                        </div>
                        <!-- Copywrite -->
                        <p><a href="#"><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
Copyright &copy;<script>document.write(new Date().getFullYear());</script> , BLKK-YPPRM All rights reserved <a href="https://colorlib.com" target="_blank"></a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <div class="bottom-footer-area d-flex justify-content-between align-items-center">
            ...
            <div class="contact-info">
                ...
                <a href="#"><span>Email:</span> blkkypprm@gmail.com</a>
            </div>
            <!-- Follow Us -->
            <div class="follow-us">
                <span>FOLLOW US</span>
