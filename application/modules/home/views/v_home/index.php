    ...
    <section class="hero-area bg-img bg-overlay-2by5" style="background-image: url(<?= base_url() ?>asset/img/background/blk.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <!-- Hero Content -->
                    <div class="hero-content text-center">
                        <h2>BLKK Ponpes Roudlotul Muta'abbidin</h2>
                        <span class="btn clever-btn">KLIK</span>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <blockquote class="blockquote text-center">
                  <p class="mb-0">Balai Latihan Kerja Komunitas | Yayasan Pondok Pesantren Roudlotul Muta'abbidin</p>
                  <footer class="blockquote-footer"><cite title="Source Title">BLKK-YPPRM</cite></footer>
                </blockquote>
            </div>
        </div>
    </div>
                ...
                <?php foreach ($new_pengumuman as $pengumuman): ?>
                    ...
                    <div class="single-upcoming-events mb-50 wow fadeInUp" data-wow-delay="250ms">
                        ...
                        <div class="date-fee d-flex justify-content-between">
                            <div class="date">
                                <p><i class="fa fa-clock"></i> BY BLKK-YPPRM <?= date('d/m/Y',strtotime($pengumuman['created_at'])) ?></p>
                            </div>
